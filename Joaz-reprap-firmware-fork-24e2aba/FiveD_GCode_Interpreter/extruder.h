...
// The pins we control
// Add pin for polulu motor control board (requires 2 for direction)
//    byte motor_dir_pin, motor_speed_pin, heater_pin, fan_pin, temp_pin, valve_dir_pin, valve_en_pin, heater_low, heater_high;
    byte motor_dir_pin, motor_dir_pinb, motor_speed_pin, heater_pin, fan_pin, temp_pin, valve_dir_pin, valve_en_pin, heater_low, heater_high;
...
public:
   ...
   //Add pin for polulu motor driver board
   ...
   extruder(byte md_pin, byte md_pinb, byte ms_pin, byte h_pin, byte f_pin, byte t_pin, byte vd_pin, byte ve_pin, signed int se_pin, byte low_heat, byte high_heat);
...
//changed this around due to two pins on polulu motor controller that drive the voltage
	e_direction = dir;
	  ...
	  digitalWrite(motor_dir_pinb, LOW);
          }
        else
          {
  	  digitalWrite(motor_dir_pin, LOW);
	  digitalWrite(motor_dir_pinb, HIGH);
          }
}
