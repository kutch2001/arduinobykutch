...
//Add another pin for polulu driver controller board
...
extruder::extruder(byte md_pin, byte md_pinb, byte ms_pin, byte h_pin, byte f_pin, byte t_pin, byte vd_pin, byte ve_pin, signed int se_pin, byte low_heat, byte high_heat)
{
         motor_dir_pin = md_pin;
         //Add motor_dir_pinb for polulu driver controller board
         motor_dir_pinb = md_pinb;
	...
	pinMode(motor_dir_pin, OUTPUT);
        //Add new pin for polulu driver controller board
	pinMode(motor_dir_pinb, OUTPUT);
	...
	digitalWrite(motor_dir_pin, EXTRUDER_FORWARD);
        //Add for polulu driver controller board
	digitalWrite(motor_dir_pinb, EXTRUDER_REVERSE);
